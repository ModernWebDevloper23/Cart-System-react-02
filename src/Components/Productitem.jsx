...
function Productitem({ product }) {
  ...
  return (
    <div
      key={product.id}
      className="w-[15vw] text-center h-[32vh] shadow-2xl rounded-xl bg-stone-900 flex flex-col px-3 py-3 items-center justify-center gap-[30px]"
    >
      ...
      <input
        ...
        onChange={() => {
          toggleIsSelected(product.id, product);
        }}
      />
      <button
        key={product.id}
